"""
Django settings for fastway_mali_41035 project.
...
ROOT_URLCONF = 'fastway_mali_41035.urls'
...
WSGI_APPLICATION = 'fastway_mali_41035.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fastway_mali_41035 API",
    "DESCRIPTION": "API documentation for fastway_mali_41035 App",
    "VERSION": "v1",
}
